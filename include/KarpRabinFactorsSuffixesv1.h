#ifndef _KARP_RABIN_FACTORS_SUFFIXES_V1_H
#define _KARP_RABIN_FACTORS_SUFFIXES_v1_H
...
class KarpRabinFactorsSuffixesv1 : public KarpRabinFactorsSuffixes {
...
public: 
	...
	KarpRabinFactorsSuffixesv1();
	KarpRabinFactorsSuffixesv1(unsigned int _n_factors, vector<unsigned long long> *_arr_kr_s, KarpRabin *_karp_rabin, const char *_ref_text, int_vector<> *_pi_inv, vector<unsigned int> *_arr_tu, vector<unsigned int> *_arr_pu, vector<unsigned int> *_arr_lu, vector<unsigned int> *_factors_start);
	virtual ~KarpRabinFactorsSuffixesv1();
